...
//Postconditions: regionName contains the name of the region, accidents contains the number of accidents (guaranteed to be >= 0)
...
// This function gets the name of the region with the lowest reported accidents for the year and the number of accidents for that region. It displays these values on the screen.
